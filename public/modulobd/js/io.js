...
SQL.IO.prototype.clientsql = function() {
	...
	var path = bp + "/modulobd/db/"+window.DATATYPES.getAttribute("db")+"/output.xsl";
...
SQL.IO.prototype.serversave = function(e, keyword) {
	...
	var url = bp + "/modulobd/backend/"+this.dom.backend.value+"/?action=save&keyword="+encodeURIComponent(name);
...
SQL.IO.prototype.serverload = function(e, keyword) {
	...
	this._name = name;
	var bp = this.owner.getOption("xhrpath");
	var url = bp + "/modulobd/backend/"+this.dom.backend.value+"/?action=load&keyword="+encodeURIComponent(name);
	this.owner.window.showThrobber();
	this.name = name;
...
SQL.IO.prototype.serverlist = function(e) {
	var bp = this.owner.getOption("xhrpath");
	var url = bp + "/modulobd/backend/"+this.dom.backend.value+"/?action=list";
	this.owner.window.showThrobber();
...
SQL.IO.prototype.serverimport = function(e) {
	...
	if (!name) { return; }
	var bp = this.owner.getOption("xhrpath");
	var url = bp + "/modulobd/backend/"+this.dom.backend.value+"/?action=import&database="+name;
	this.owner.window.showThrobber();
