...
new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
    ...
    created: function created() {
        ...
        axios.get("/api/proyectos/" + this.proyectoId + "/documentacion").then(function (res) {
            return _this.documentos = res.data;
        });
    ...
    methods: {
        openEditModal: function openEditModal(documentos) {
            this.fillDocumentos = Object.assign({}, documentos);
            $('#editar-documentos').modal("show");
        },
        store: function store(idfk) {
            var _this2 = this;

            this.newDocumentos.FK_ProyectoId = idfk;
            axios.post('../api/documentacion/', this.newDocumentos).then(function (res) {
                return _this2.documentos.push(res.data);
            });
        ...
        update: function update() {
            ...
            axios.put('../api/documentacion/' + this.fillDocumentos.PK_id, this.fillDocumentos).then(function (response) {
                _this3.documentos = _this3.documentos.map(function (value) {
                    return value.PK_id == _this3.fillDocumentos.PK_id ? _this3.fillDocumentos : value;
                });
                _this3.fillDocumentos = {};
        ...
        destroy: function destroy(documento) {
            ...
            axios.delete('../api/documentacion/' + documento.PK_id).then(function () {
                _this4.documentos = _this4.documentos.filter(function (value) {
