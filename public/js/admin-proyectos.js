...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_proyecto_tabla__ = __webpack_require__(61);
...
var vm = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
    el: '#app',
    components: { proyectoTabla: __WEBPACK_IMPORTED_MODULE_2__components_proyecto_tabla___default.a },
    data: { proyectos: [], seleccion: {} },
    created: function created() {
        var _this = this;

        axios.get('/api/proyectos').then(function (res) {
...
Component.options.__file = "C:\\xampp\\htdocs\\ModuloCentral\\resources\\assets\\components\\proyecto-tabla.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b6e3b952", Component.options)
  } else {
    hotAPI.reload("data-v-b6e3b952", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b6e3b952", module.exports)
  }
}
