...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_list_group_crud__ = __webpack_require__(30);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_focus__ = __webpack_require__(50);
    ...
    methods: {
        store: function store() {
            ...
            axios.post(this.rest, this.newItem).then(function (res) {
                _this2.items = [].concat(_toConsumableArray(_this2.items), [res.data]);
...
Component.options.__file = "/var/www/modulo-central/resources/assets/components/list-group-crud.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-632eddbe", Component.options)
  } else {
    hotAPI.reload("data-v-632eddbe", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-632eddbe", module.exports)
  }
}
