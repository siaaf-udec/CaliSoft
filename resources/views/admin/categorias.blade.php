...
<div id="app" class="col-md-10 col-md-offset-1">
    <div class="panel panel-primar note note-info">
                        ...
                        <div class="form-group form-group-sm">
                            <form @submit.prevent="store()">
                                ...
                                @{{formErrors.plataforma[0]}}
                                        ...
                                        <hr style="border: 2px solid #3598DC;">
                                    </div>
                                    <div class="form-group">
        ...
        <div class="modal fade " id="eliminar-categoria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"></span>
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            ...
                            <form @submit.prevent="destroy(elimiCategoria)">

                                <div class="form-group">
                                    <label for="title">¿Desea eliminar la categoría @{{elimiCategoria.nombre}}?</label>
